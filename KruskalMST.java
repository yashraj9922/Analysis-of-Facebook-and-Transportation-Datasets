...
public class KruskalMST {
    ...
    public static void main(String[] args) {
        In in = new In("Graph_03.txt");
        In in1 = new In("Graph_02.txt");
        In in2 = new In("Graph_01.txt");
        ...
        double avg = (mst.weight() + mst1.weight() + mst2.weight())/3.0d;
        System.out.println("Average MST Weight = " + avg);
